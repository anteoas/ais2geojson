...
echo
echo '2017-03-01T13:41:14;!BSVDM,1,1,,A,33m:Ul0P@t0w2ITVsUk=cJtL01q@,0*6A' | ./aisformat
echo expected:
...
echo
echo '2017-03-01T13:41:14;!BSVDM,1,1,,A,B3m6?EP0@H9sCka8ibdtKwVUoP06,0*21' | ./aisformat
echo expected:
...
echo
echo '2017-03-01T13:41:14;!BSVDM,1,1,,B,13nW`F001V0pk1jV0r5s@8rHP<0i,0*13' | ./aisformat
echo expected:
